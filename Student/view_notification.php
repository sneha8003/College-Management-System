<?php
//session file that contains student session and header property is called
include 'session.php';
?>
<!DOCTYPE html>
<html>
...
<!-- section part is started -->
  <section>
    ...
    <main>
      <!-- student sidebar that contain the side bar with mentioning the criteria or job for student pages -->
...
<!-- new div is made named as courses -->
  ...
  <?php 
// module_leader notification_tableGenerator is declared
 require '../module_leader/notification_tableGenerator.php';
 ...
 $tg->setHeadings(['id','Message','fName','lName','Date']);
  // statement of table column is selected from notifiction table.
