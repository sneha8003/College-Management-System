...
//table_generator is declared
 ...
 $tg->setHeadings(['id','f_name','l_name','username','address','nationality','dob','gender','p_challenged','contact_number','email','user_type']);
  // statement of table column is selected from table_user
 $stmt = $pdo->prepare("SELECT id,f_name,l_name,username,address,nationality,dob,gender,p_challenged,contact_number,email,user_type FROM tbl_user where archive='no'");
