...
// table generator has been called
 ...
 $stmt = $pdo->prepare("SELECT id,f_name,l_name,username,address,nationality,dob,gender,p_challenged,contact_number,email,user_type FROM tbl_user where user_type='admin'");
