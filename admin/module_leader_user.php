...
//table_generator is declared
 ...
 $tg->setHeadings(['id','f_name','l_name','address','nationality','dob','gender','p_challenged','contact_number','email','user_type']);
  // statement of table column is selected from tbl_user where usertype is module leader
 $stmt = $pdo->prepare("SELECT id,f_name,l_name,address,nationality,dob,gender,p_challenged,contact_number,email,user_type FROM tbl_user where user_type='module_leader'");
