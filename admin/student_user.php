...
// table_generator is declared
 ...
 $tg = new TableGenerator();
  // heading for different olumn is set
 ...
 $stmt = $pdo->prepare("SELECT id,f_name,l_name,username,address,nationality,dob,gender,p_challenged,contact_number,email,user_type FROM tbl_user where user_type='student'");
